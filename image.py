import numpy as np
import png
from PIL import Image as PILImage  # Importe a classe Image do PIL
...
class Image:
    ...
    def read_image(self, filename, gamma=2.2):
        ...
        '''
        im = png.Reader(filename).asFloat()  # Corrigido!
    ...
    def open(cls, filename):
        ...
        Args:
            filename (str): O caminho do arquivo da imagem.

        Returns:
            Image: Um objeto Image contendo a imagem carregada.
        """
